...
class CompanySettingsController extends Controller
{
    ...
    public function showNotes()
    {
        ...
        $data['accounts'] = AccountTitles::where('is_deleted', 0)
                                ->where('is_active', 1)->get();

        $data['charges'] = Charges::where('is_deleted', 0)
                                ->get();
        
        $data['departments'] = Departments::where('is_deleted', 0)
                                ->where('is_active', 1)->get();
        
        $data['company'] = CompanySettings::findOrFail(1);
    ...
    public function update(Request $request, $id)
    {
        Validator::make($request->all(),
            [
                ...
                'electric_charge_id' => 'required|not_in:0'
            ...
            'electric_charge_id' => 'electric withholding charge'
        ...
        $company->electric_charge_id = $request->input('electric_charge_id');
