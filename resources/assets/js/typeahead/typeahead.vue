...
<script>
  import {getRequest} from '@/typeahead/js/httpUtils'
  import {isString} from '@/typeahead/js/objectUtils'
  import {
    isElement,
    on,
    off,
    ...
    EVENTS
  } from '@/typeahead/js/domUtils'
  import Dropdown from '@/typeahead/Dropdown.vue'
  export default {
    components: {Dropdown},
    props: {
      value: {
