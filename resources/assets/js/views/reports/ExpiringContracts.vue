...
<template>
    ...
    <div hidden>
        <div>
            <div class="animated fadeIn" ref="expiringContracts">
                <b-row>
                    <b-col sm="12">
                        <b-card >
                            <table width="100%">
...
export default {
    ...
    async created(){
        ...
        await this.$http.get('api/reports/expiringcontracts', {
            headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('token')
                }
        })
        ...
        await this.d.print(this.$refs.expiringContracts, [this.cssText])
    },
    mounted(){
